# 05 Working with Temporary Tables
...
This example is exactly the same as [Inserting Into Tables](../04/04_insert_into.md) except that both `server_logs` and `client_errors` are created as temporary tables.
