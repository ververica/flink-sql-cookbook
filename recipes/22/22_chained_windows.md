...
For this, you could run two queries, similar to the one in [Aggregating Time Series Data](../06/06_group_by_window.md). 
...
We then use a [Statements Set](../17/17_statement_sets.md) to write out the two result tables. 
...
![Jobgraph](jobgraph_chained.png)

### Result 1 Minute Aggregations

![Results](results_1m.png)
...
![Jobgraph](jobgraph_non_chained.png)
